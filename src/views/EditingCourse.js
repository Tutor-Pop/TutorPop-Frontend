    ...
    return (
        <div className="CourseCreation">
            ...
            <div className="Element">
                ...
                <div className="Bar">
                    <input type="text" className="form-control" id="course_name_bar" />
                </div>
            </div>
            <div className="Element">
